...
public class SortedArrayST<Key extends Comparable<Key>, Value> {
	...
	public static void main(String[] args) {
		...
		testDelete("ABDFK","12345", "D","ABFK","1245");    // another basic test
		testDelete("ABCDEFGH","12345678", "I","ABCDEFGH","12345678");   // if the key is not in the array
		...
		testPut("AEIOU","13456", "A","1", "AEIOU","13456"); //key already in array
		testPut("AEIOU","13456", "A","2", "AEIOU","23456"); // updating value if key is already in array
		testPut("AEIOU","13456", "Z","9", "AEIOUZ","134569"); // Insert last in array
		testPut("BEIOU","13456", "A","9", "ABEIOU","913456"); // Insert first in array
